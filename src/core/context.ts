...
// [C-2] 공개 done 전사 그대로 — self 포함(stateless 드라이버의 자기 기억). whisper는 history에 없어 자동 제외([223] §2).
// 화자 구분은 드라이버 prompt의 [이름] 라벨로 → self 포함해도 echo chamber는 prompt 설계로 방지(드라이버 책임).
